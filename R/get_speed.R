...
#' @param seconds_per_timestep the number of seconds between timestamps (e.g. for data recorded at 1 Hz, the value would be 1, for data recorded every 30 sec, the value would be 30)
...
#'
#' @export
get_speed <- function(x_i, y_i, seconds_per_timestep, t_window = 1, forward = T){
  ...
  dt <- seconds_per_timestep * t_window
